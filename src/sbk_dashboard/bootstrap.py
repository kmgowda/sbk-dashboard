...
from sbk_dashboard.contracts import BYTES_PER_KIBIBYTE, BYTES_PER_MEBIBYTE

LOGGER = logging.getLogger(__name__)

DOWNLOAD_TIMEOUT_SECONDS = 60
DOWNLOAD_CHUNK_BYTES = 128 * BYTES_PER_KIBIBYTE
DOWNLOAD_PROGRESS_INTERVAL_SECONDS = 0.25
CHECKSUM_CHUNK_BYTES = BYTES_PER_MEBIBYTE
ARCHIVE_DRIVE_PREFIX_CHARACTERS = 2
ZIP_UNIX_MODE_SHIFT = 16
ZIP_UNIX_FILE_TYPE_MASK = 0o170000
ZIP_UNIX_SYMLINK_TYPE = 0o120000
BYTE_UNIT_BASE = BYTES_PER_KIBIBYTE
