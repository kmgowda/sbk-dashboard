...
class ContainerContractTest(unittest.TestCase):
    ...
    def test_ci_runs_smoke_and_builds_both_linux_architectures(self):
        ...
        self.assertIn("images: |", self.workflow)
        self.assertIn("            kmgowda/sbk-dashboard", self.workflow)
        self.assertIn("ghcr.io/kmgowda/sbk-dashboard", self.workflow)
        ...
        self.assertIn("Log in to GitHub Container Registry", self.workflow)
        self.assertIn("packages: write", self.workflow)
        self.assertIn("secrets.GITHUB_TOKEN", self.workflow)
        self.assertIn("Verify version and latest tags in both registries", self.workflow)
